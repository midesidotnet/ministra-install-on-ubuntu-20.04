...
```bash
apt-get install git
git clone https://github.com/midesidotnet/ministra-install-ubuntu-20.04.git
...
You can access your stalker portal at 

http://"YOUR SERVER IP ADDRESS"/stalker_portal 
